...
const domain = __ENV.DEPLOYMENT_DOMAIN
  ? __ENV.DEPLOYMENT_DOMAIN
  : __ENV.INPUT_DOMAIN
    ? __ENV.INPUT_DOMAIN
    : 'https://tiarebalbi.com';
...
export default function main() {
  ...
  group(`Go to Article 1 - ${domain}/article/the-future-of-serverless-computing`, function () {
    // First post
  ...
  group(`Go to Similar Post 1 - ${domain}/article/kotlin-delegated-properties`, function () {
    // Second post
  ...
  group(`Go to Similar Post 2 - ${domain}/article/week-4-the-rate-limit-pattern`, function () {
    // Third post
